...
<body>
  <div class="page">
    <div class="header">
      ...
      <div>
        ...
        <div class="meta">
          <div><span data-lang="en"><strong>Execution ID:</strong> <code>2e8104f83d09</code></span><span data-lang="zh-TW"><strong>執行 ID:</strong> <code>2e8104f83d09</code></span></div>
          <div><span data-lang="en"><strong>Target:</strong> www.bilibili.com</span><span data-lang="zh-TW"><strong>目標:</strong> www.bilibili.com</span></div>
    ...
    <div class="top-grid">
      <section class="section">
        ...
        <h2 style="font-size:24px; line-height:1.25;"><span data-lang="en">This run suggests the issue starts very close to the device, which is often consistent with Wi-Fi quality, the local router, or the home network.</span><span data-lang="zh-TW">這次結果比較像是在非常靠近這台裝置的位置開始出現問題，常見於 Wi-Fi 品質、家用路由器或本地網路。</span></h2>
        ...
        <div class="callout">
          ...
          <span><span data-lang="en">Ask the user to retry closer to the router or on wired ethernet if possible.</span><span data-lang="zh-TW">請使用者靠近路由器重試；如果可行，優先改用有線網路。</span></span>
        </div>
        <div class="mini-grid">
          <div class="mini">
  ...
  <div class="note"><span data-lang="en">Configured service ports were reachable.</span><span data-lang="zh-TW">目標服務埠可達。</span></div>
      ...
      <aside class="section">
        ...
        <div class="list">
          <div class="row"><span><span data-lang="en">Destination</span><span data-lang="zh-TW">目的端</span></span><span><span data-lang="en">Blibli</span><span data-lang="zh-TW">Blibli</span></span></div>
          <div class="row"><span><span data-lang="en">Generated</span><span data-lang="zh-TW">產生時間</span></span><span><span data-lang="en">2026-04-02 05:36:55 UTC</span><span data-lang="zh-TW">2026-04-02 05:36:55 UTC</span></span></div>
  ...
  <li><span data-lang="en">DNS checks passed: 1/1.</span><span data-lang="zh-TW">DNS 檢查通過: 1/1。</span></li>
      ...
      <section class="section">
        ...
        <ul>
  <li><span data-lang="en">Ask the user to retry closer to the router or on wired ethernet if possible.</span><span data-lang="zh-TW">請使用者靠近路由器重試；如果可行，優先改用有線網路。</span></li>
...
<tr><td>VPN gateway DNS</td><td>www.bilibili.com</td><td><span data-lang="en">Pass</span><span data-lang="zh-TW">通過</span></td><td>21 ms</td><td>103.151.151.133, 103.151.151.134, 103.151.151.4, 103.151.151.5, 103.151.151.6</td></tr>
</tbody></table>
</div>
    </details>
    <details>
...
<tr><td>VPN gateway HTTPS</td><td>www.bilibili.com:443</td><td><span data-lang="en">Pass</span><span data-lang="zh-TW">通過</span></td><td>41 ms</td><td><span data-lang="en">Connection established.</span><span data-lang="zh-TW">連線已建立。</span></td></tr>
</tbody></table>
</div>
    </details>
    <details>
...
追蹤 i.w.bilicdn1.com [103.151.151.133] 的路由:
...
追蹤完成。</pre></div>
  ...
  <script type="application/json" id="copy-payload">{"itSummary":{"en":"Status: Action Needed\r\nPossible fault domain: Local network or Wi-Fi\r\nOverall finding: This run suggests the issue starts very close to the device, which is often consistent with Wi-Fi quality, the local router, or the home network.\r\nInterpretation: Packet loss is 100% with no stronger downstream signal. The local access network is still the first place to verify.\r\nRoute Summary: Packet loss is high enough to suggest an end-to-end connectivity problem.\r\nRecommended next action: Ask the user to retry closer to the router or on wired ethernet if possible.\r\nExecution ID: 2e8104f83d09","zh-TW":"\u72C0\u614B: \u9700\u8981\u8655\u7406\r\n\u53EF\u80FD\u6545\u969C\u5340\u6BB5: \u672C\u5730\u7DB2\u8DEF\u6216 Wi-Fi\r\n\u7E3D\u9AD4\u89C0\u5BDF: \u9019\u6B21\u7D50\u679C\u6BD4\u8F03\u50CF\u662F\u5728\u975E\u5E38\u9760\u8FD1\u9019\u53F0\u88DD\u7F6E\u7684\u4F4D\u7F6E\u958B\u59CB\u51FA\u73FE\u554F\u984C\uFF0C\u5E38\u898B\u65BC Wi-Fi \u54C1\u8CEA\u3001\u5BB6\u7528\u8DEF\u7531\u5668\u6216\u672C\u5730\u7DB2\u8DEF\u3002\r\n\u5224\u8B80: \u76EE\u524D\u5C01\u5305\u907A\u5931\u70BA 100% \uFF0C\u800C\u4E14\u6C92\u6709\u66F4\u660E\u78BA\u7684\u4E0B\u6E38\u8A0A\u865F\uFF0C\u5EFA\u8B70\u5148\u5F9E\u672C\u5730\u63A5\u5165\u7DB2\u8DEF\u958B\u59CB\u78BA\u8A8D\u3002\r\n\u8DEF\u7531\u6458\u8981: \u5C01\u5305\u907A\u5931\u5DF2\u9AD8\u5230\u8DB3\u4EE5\u61F7\u7591\u7AEF\u5230\u7AEF\u9023\u7DDA\u554F\u984C\u3002\r\n\u5EFA\u8B70\u4E0B\u4E00\u6B65: \u8ACB\u4F7F\u7528\u8005\u9760\u8FD1\u8DEF\u7531\u5668\u91CD\u8A66\uFF1B\u5982\u679C\u53EF\u884C\uFF0C\u512A\u5148\u6539\u7528\u6709\u7DDA\u7DB2\u8DEF\u3002\r\n\u57F7\u884C ID: 2e8104f83d09"},"incidentNote":{"en":"Target: www.bilibili.com\r\nMachine: MR-27526\r\nStatus: Action Needed\r\nPossible fault domain: Local network or Wi-Fi\r\nObservations: Ping success rate observed: 0% with average latency - ms.\r\nRecommended next action: Ask the user to retry closer to the router or on wired ethernet if possible.","zh-TW":"\u76EE\u6A19: www.bilibili.com\r\n\u88DD\u7F6E\u540D\u7A31: MR-27526\r\n\u72C0\u614B: \u9700\u8981\u8655\u7406\r\n\u53EF\u80FD\u6545\u969C\u5340\u6BB5: \u672C\u5730\u7DB2\u8DEF\u6216 Wi-Fi\r\n\u89C0\u5BDF\u5230\u7684\u8A0A\u865F: Ping \u6210\u529F\u7387: 0% \uFF0C\u5E73\u5747\u5EF6\u9072 - ms\u3002\r\n\u5EFA\u8B70\u4E0B\u4E00\u6B65: \u8ACB\u4F7F\u7528\u8005\u9760\u8FD1\u8DEF\u7531\u5668\u91CD\u8A66\uFF1B\u5982\u679C\u53EF\u884C\uFF0C\u512A\u5148\u6539\u7528\u6709\u7DDA\u7DB2\u8DEF\u3002"}}</script>
  <script>
    (() => {
